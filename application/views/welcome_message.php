            ...
            <ul class="navbar-nav ml-auto">
                ...
                <?php if (isset($_SESSION['logged_user'])){?>
                    <li class="nav-item mx-0 mx-lg-1 row" style="padding-left: 10%">
                        ...
                        <span class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" ><?php echo $_SESSION['username'] ;?></span>
                    </li>
                    <?php
                }
                else { ?>
    ...
    transition: border-color .15s ease-in-out,box-shadow .15s ease-in-out,-webkit-box-shadow .15s ease-in-out;"/>
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <input type="date" class="datepicker form-control" value=""/>
                                </div>
                                <div class="col-md-6 form-group">
                                    <input type="time" class="form-control" placeholder="Confirm Password *" value=""/>
                                </div>
                            </div>
